...
OUT_DIR="${OUT_DIR:-/tmp/open_graph_revenue_minimum_llm}"
    ...
    "answers": [
        {
            ...
            "path": raw_path,
            "strategy": "open_ent_bounded_graph_context_depth_3_raw_model",
            "answer_kind": "raw",
        },
        {
            "key": "repaired_model",
            ...
            "path": repaired_path,
            "strategy": "open_ent_bounded_graph_context_depth_3_repaired_model",
        ...
        },
        {
            ...
            "path": generic_path,
            "strategy": "open_ent_bounded_graph_context_depth_3_generic_baseline",
...
if raw:
    print("open_graph_revenue_llm raw_unknown_citations=" + json.dumps(raw.get("unknown_citations", [])))
    print("open_graph_revenue_llm raw_policy_violations=" + json.dumps(raw.get("citation_policy_violations", [])))
    print("open_graph_revenue_llm raw_unsupported_statement_count=" + str(raw.get("unsupported_statement_count")))
