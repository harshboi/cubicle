...
OUT_DIR=${OUT_DIR:-/tmp/real_github_issue_pr_minimum}
...
for forbidden in [
    ...
    if forbidden in text:
        raise SystemExit("real GitHub open graph context leaked " + forbidden)
PY
}
    ...
    "answers": [
        {
            ...
            "label": "Depth-2 real GitHub open graph traversal",
            "path": depth_path,
            "strategy": "real_github_open_ent_depth_2",
        ...
        },
        {
            ...
            "path": seed_only_path,
            "strategy": "real_github_open_ent_depth_0",
