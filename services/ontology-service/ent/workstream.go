...
type Workstream struct {
	...
	DeletionState workstream.DeletionState `json:"deletion_state,omitempty"`
	...
	ACLState workstream.ACLState `json:"acl_state,omitempty"`
...
type WorkstreamEdges struct {
	...
	// Most recent evidence supporting this workstream state.
...
func (e WorkstreamEdges) LatestEvidenceOrErr() (*Evidence, error) {
...
func (*Workstream) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case workstream.FieldID, workstream.FieldSourceScopeStateID, workstream.FieldLatestEvidenceID, workstream.FieldEvidenceCount, workstream.FieldEventCount:
			values[i] = new(sql.NullInt64)
		case workstream.FieldKey, workstream.FieldTitle, workstream.FieldStatus, workstream.FieldSummary, workstream.FieldSearchText, workstream.FieldSourceSystem, workstream.FieldSourceInstance, workstream.FieldExternalKind, workstream.FieldExternalID, workstream.FieldSourceURL, workstream.FieldSourceVersion, workstream.FieldContentHash, workstream.FieldDeletionState, workstream.FieldACLPolicyKey, workstream.FieldVisibilityHash, workstream.FieldACLState, workstream.FieldFreshnessState, workstream.FieldVisibility:
			values[i] = new(sql.NullString)
		case workstream.FieldSourceUpdatedAt, workstream.FieldDeletedAt, workstream.FieldACLCheckedAt, workstream.FieldFreshnessCheckedAt, workstream.FieldLastConfirmedAt, workstream.FieldLastChangedAt, workstream.FieldFirstSeenAt, workstream.FieldLastActivityAt, workstream.FieldCreatedAt, workstream.FieldUpdatedAt:
...
func (_m *Workstream) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case workstream.FieldSourceSystem:
			if value, ok := values[i].(*sql.NullString); !ok {
		...
		case workstream.FieldExternalKind:
			if value, ok := values[i].(*sql.NullString); !ok {
...
// QueryLatestEvidence queries the "latest_evidence" edge of the Workstream entity.
func (_m *Workstream) QueryLatestEvidence() *EvidenceQuery {
	return NewWorkstreamClient(_m.config).QueryLatestEvidence(_m)
}
