...
const (
	// Label holds the string label denoting the documentlensresult type in the database.
	Label = "document_lens_result"
	...
	// Table holds the table name of the documentlensresult in the database.
	Table = "document_lens_results"
	// LensTable is the table that holds the lens relation/edge.
	LensTable = "document_lens_results"
	...
	WindowTable = "document_lens_results"
	...
	DocumentTable = "document_lens_results"
	...
	LatestEvidenceTable = "document_lens_results"
...
// Columns holds all SQL columns for documentlensresult fields.
var Columns = []string{
	FieldID,
	FieldWorkLensID,
...
// RelationKind values.
const (
	RelationKindCreated     RelationKind = "created"
	RelationKindEdited      RelationKind = "edited"
...
func RelationKindValidator(rk RelationKind) error {
	switch rk {
	case RelationKindCreated, RelationKindEdited, RelationKindCommentedOn:
		return nil
	default:
		return fmt.Errorf("documentlensresult: invalid enum value for relation_kind field: %q", rk)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("documentlensresult: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("documentlensresult: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("documentlensresult: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("documentlensresult: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the DocumentLensResult queries.
