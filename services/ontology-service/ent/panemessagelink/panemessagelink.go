...
const (
	// Label holds the string label denoting the panemessagelink type in the database.
	Label = "pane_message_link"
	...
	EvidenceFieldID = "id"
	// Table holds the table name of the panemessagelink in the database.
	Table = "pane_message_links"
	// PaneTable is the table that holds the pane relation/edge.
	PaneTable = "pane_message_links"
	...
	MessageTable = "pane_message_links"
	...
	LatestEvidenceTable = "pane_message_links"
...
// Columns holds all SQL columns for panemessagelink fields.
var Columns = []string{
	FieldPaneID,
	FieldMessageID,
	FieldRelationKind,
...
func RelationKindValidator(rk RelationKind) error {
	...
	case RelationKindAuthored, RelationKindMentionsPerson, RelationKindRepliedTo:
		return nil
	default:
		return fmt.Errorf("panemessagelink: invalid enum value for relation_kind field: %q", rk)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("panemessagelink: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("panemessagelink: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the PaneMessageLink queries.
