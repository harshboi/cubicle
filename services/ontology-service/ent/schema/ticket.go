...
// Edges declares the typed work graph relationships that are useful for POC
// search, trace, and execution-context queries.
func (Ticket) Edges() []ent.Edge {
	return []ent.Edge{
		...
		edge.From("work_panes", WorkPane.Type).
			Ref("tickets").
			Comment("Person work panes that include this ticket."),
	}
}
