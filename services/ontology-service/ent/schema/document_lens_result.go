...
func (DocumentLensResult) Annotations() []entschema.Annotation {
	return edgeSchemaAnnotations("work_lens_id", "document_id", "relation_kind")
}
...
func (DocumentLensResult) Fields() []ent.Field {
	return appendFields(
		...
		linkFields("relation_kind", documentRelationValues()),
	)
}
...
func (DocumentLensResult) Indexes() []ent.Index {
	return []ent.Index{
		semanticEdgeIndex("work_lens_id", "document_id", "relation_kind"),
