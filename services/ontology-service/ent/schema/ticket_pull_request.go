...
func (TicketPullRequest) Annotations() []entschema.Annotation {
	return edgeSchemaAnnotations("ticket_id", "pull_request_id", "ticket_pull_request_kind")
}
...
func (TicketPullRequest) Fields() []ent.Field {
	return appendFields(
		...
		linkFields("ticket_pull_request_kind", []string{relationImplementedBy}),
	)
}
...
func (TicketPullRequest) Indexes() []ent.Index {
	return []ent.Index{
		semanticEdgeIndex("ticket_id", "pull_request_id", "ticket_pull_request_kind"),
