...
// Fields defines source-neutral identity fields plus source-specific handles.
...
// Edges connects Person only to bounded work surfaces, not directly to every
// document, ticket, message, or pull request the person has touched.
func (Person) Edges() []ent.Edge {
	return []ent.Edge{
		edge.To("work_surfaces", WorkSurface.Type).
			Comment("Bounded Cubicle work surfaces owned by this person."),
	}
}
