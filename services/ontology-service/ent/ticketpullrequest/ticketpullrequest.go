...
// RelationKind values.
const (
	RelationKindImplementedBy RelationKind = "implemented_by"
)
...
func RelationKindValidator(rk RelationKind) error {
	switch rk {
	case RelationKindImplementedBy:
		return nil
	default:
		return fmt.Errorf("ticketpullrequest: invalid enum value for relation_kind field: %q", rk)
	}
}
