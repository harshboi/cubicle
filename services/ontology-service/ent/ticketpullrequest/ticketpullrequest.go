...
const (
	// Label holds the string label denoting the ticketpullrequest type in the database.
	Label = "ticket_pull_request"
	...
	// FieldTicketPullRequestKind holds the string denoting the ticket_pull_request_kind field in the database.
	FieldTicketPullRequestKind = "ticket_pull_request_kind"
	...
	// Table holds the table name of the ticketpullrequest in the database.
	Table = "ticket_pull_requests"
	// TicketTable is the table that holds the ticket relation/edge.
	TicketTable = "ticket_pull_requests"
	...
	PullRequestTable = "ticket_pull_requests"
	...
	LatestEvidenceTable = "ticket_pull_requests"
...
// Columns holds all SQL columns for ticketpullrequest fields.
var Columns = []string{
	FieldID,
	FieldTicketID,
	FieldPullRequestID,
	FieldTicketPullRequestKind,
...
// TicketPullRequestKind defines the type for the "ticket_pull_request_kind" enum field.
type TicketPullRequestKind string

// TicketPullRequestKind values.
const (
	TicketPullRequestKindImplementedBy TicketPullRequestKind = "implemented_by"
)

func (tprk TicketPullRequestKind) String() string {
	return string(tprk)
}

// TicketPullRequestKindValidator is a validator for the "ticket_pull_request_kind" field enum values. It is called by the builders before save.
func TicketPullRequestKindValidator(tprk TicketPullRequestKind) error {
	switch tprk {
	case TicketPullRequestKindImplementedBy:
		return nil
	default:
		return fmt.Errorf("ticketpullrequest: invalid enum value for ticket_pull_request_kind field: %q", tprk)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketpullrequest: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("ticketpullrequest: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketpullrequest: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("ticketpullrequest: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the TicketPullRequest queries.
...
// ByTicketPullRequestKind orders the results by the ticket_pull_request_kind field.
func ByTicketPullRequestKind(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTicketPullRequestKind, opts...).ToFunc()
}
