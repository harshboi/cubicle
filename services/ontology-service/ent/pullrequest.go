...
type PullRequestEdges struct {
	...
	// Person work panes that include this pull request.
...
// was not loaded in eager-loading.
func (e PullRequestEdges) WorkPanesOrErr() ([]*WorkPane, error) {
	if e.loadedTypes[1] {
...
// QueryWorkPanes queries the "work_panes" edge of the PullRequest entity.
func (_m *PullRequest) QueryWorkPanes() *WorkPaneQuery {
	return NewPullRequestClient(_m.config).QueryWorkPanes(_m)
}
