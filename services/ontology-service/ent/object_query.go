...
func (_q *ObjectQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ObjectQuery) FirstIDX(ctx context.Context) int {
...
func (_q *ObjectQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ObjectQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *ObjectQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *ObjectQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
