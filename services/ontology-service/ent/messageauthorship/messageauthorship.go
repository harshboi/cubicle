...
const (
	// Label holds the string label denoting the messageauthorship type in the database.
	Label = "message_authorship"
	...
	// Table holds the table name of the messageauthorship in the database.
	Table = "message_authorships"
	// PersonTable is the table that holds the person relation/edge.
	PersonTable = "message_authorships"
	...
	MessageTable = "message_authorships"
	...
	LatestEvidenceTable = "message_authorships"
...
// Columns holds all SQL columns for messageauthorship fields.
var Columns = []string{
	FieldID,
	FieldPersonID,
	FieldMessageID,
...
const (
	...
	AuthorshipKindSender AuthorshipKind = "sender"
)
...
func AuthorshipKindValidator(ak AuthorshipKind) error {
	switch ak {
	case AuthorshipKindAuthor, AuthorshipKindSender:
		return nil
	default:
		return fmt.Errorf("messageauthorship: invalid enum value for authorship_kind field: %q", ak)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("messageauthorship: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("messageauthorship: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("messageauthorship: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("messageauthorship: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the MessageAuthorship queries.
