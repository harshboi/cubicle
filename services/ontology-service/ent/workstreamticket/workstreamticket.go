...
const (
	...
	// WorkstreamFieldID holds the string denoting the ID field of the Workstream.
	WorkstreamFieldID = "id"
...
func RelationKindValidator(rk RelationKind) error {
	switch rk {
	case RelationKindContains:
		return nil
	default:
		return fmt.Errorf("workstreamticket: invalid enum value for relation_kind field: %q", rk)
	}
}
...
func newWorkstreamStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.To(WorkstreamInverseTable, WorkstreamFieldID),
