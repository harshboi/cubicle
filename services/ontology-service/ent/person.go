...
type PersonEdges struct {
	...
	// Source-native identities and handles that resolve to this person.
...
func (*Person) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case person.FieldKey, person.FieldDisplayName, person.FieldPrimaryEmail, person.FieldGithubLogin, person.FieldJiraAccountID, person.FieldSlackUserID, person.FieldGoogleAccountID, person.FieldAvatarURL, person.FieldSummary, person.FieldSearchText, person.FieldFreshnessState, person.FieldVisibility:
