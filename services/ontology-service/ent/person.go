...
type PersonEdges struct {
	// Bounded Cubicle work surfaces owned by this person.
	WorkSurfaces []*WorkSurface `json:"work_surfaces,omitempty"`
	// loadedTypes holds the information for reporting if a
	// type was loaded (or requested) in eager-loading or not.
	loadedTypes [1]bool
}

// WorkSurfacesOrErr returns the WorkSurfaces value or an error if the edge
// was not loaded in eager-loading.
func (e PersonEdges) WorkSurfacesOrErr() ([]*WorkSurface, error) {
	if e.loadedTypes[0] {
		return e.WorkSurfaces, nil
	}
	return nil, &NotLoadedError{edge: "work_surfaces"}
}
...
// QueryWorkSurfaces queries the "work_surfaces" edge of the Person entity.
func (_m *Person) QueryWorkSurfaces() *WorkSurfaceQuery {
	return NewPersonClient(_m.config).QueryWorkSurfaces(_m)
}
