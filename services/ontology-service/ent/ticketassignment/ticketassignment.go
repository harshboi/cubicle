...
const (
	// Label holds the string label denoting the ticketassignment type in the database.
	...
	// FieldAssignmentKind holds the string denoting the assignment_kind field in the database.
	FieldAssignmentKind = "assignment_kind"
	...
	// Table holds the table name of the ticketassignment in the database.
	Table = "ticket_assignments"
	// PersonTable is the table that holds the person relation/edge.
	PersonTable = "ticket_assignments"
	...
	TicketTable = "ticket_assignments"
	...
	LatestEvidenceTable = "ticket_assignments"
...
// Columns holds all SQL columns for ticketassignment fields.
var Columns = []string{
	FieldID,
	FieldPersonID,
	FieldTicketID,
...
// AssignmentKind defines the type for the "assignment_kind" enum field.
type AssignmentKind string

// AssignmentKind values.
const (
	AssignmentKindAssignee AssignmentKind = "assignee"
	AssignmentKindReporter AssignmentKind = "reporter"
	AssignmentKindOwner    AssignmentKind = "owner"
)

func (ak AssignmentKind) String() string {
	return string(ak)
}

// AssignmentKindValidator is a validator for the "assignment_kind" field enum values. It is called by the builders before save.
func AssignmentKindValidator(ak AssignmentKind) error {
	switch ak {
	case AssignmentKindAssignee, AssignmentKindReporter, AssignmentKindOwner:
		return nil
	default:
		return fmt.Errorf("ticketassignment: invalid enum value for assignment_kind field: %q", ak)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketassignment: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("ticketassignment: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketassignment: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("ticketassignment: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the TicketAssignment queries.
...
// ByAssignmentKind orders the results by the assignment_kind field.
func ByAssignmentKind(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAssignmentKind, opts...).ToFunc()
}
