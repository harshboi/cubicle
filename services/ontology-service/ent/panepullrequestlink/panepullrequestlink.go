...
const (
	// Label holds the string label denoting the panepullrequestlink type in the database.
	Label = "pane_pull_request_link"
	...
	WorkPaneFieldID = "id"
	// PullRequestFieldID holds the string denoting the ID field of the PullRequest.
	PullRequestFieldID = "id"
	// EvidenceFieldID holds the string denoting the ID field of the Evidence.
	EvidenceFieldID = "id"
	// Table holds the table name of the panepullrequestlink in the database.
	Table = "pane_pull_request_links"
	// PaneTable is the table that holds the pane relation/edge.
	PaneTable = "pane_pull_request_links"
	...
	PullRequestTable = "pane_pull_request_links"
	...
	LatestEvidenceTable = "pane_pull_request_links"
...
// Columns holds all SQL columns for panepullrequestlink fields.
var Columns = []string{
	FieldPaneID,
	FieldPullRequestID,
	FieldRelationKind,
...
func RelationKindValidator(rk RelationKind) error {
	...
	case RelationKindAuthored, RelationKindReviewed, RelationKindCommentedOn:
		return nil
	default:
		return fmt.Errorf("panepullrequestlink: invalid enum value for relation_kind field: %q", rk)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("panepullrequestlink: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("panepullrequestlink: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the PanePullRequestLink queries.
...
func newPullRequestStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.To(PullRequestInverseTable, PullRequestFieldID),
