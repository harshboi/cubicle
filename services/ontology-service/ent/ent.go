...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			panedocumentlink.Table:       panedocumentlink.ValidColumn,
			panemessagelink.Table:        panemessagelink.ValidColumn,
			panepullrequestlink.Table:    panepullrequestlink.ValidColumn,
			paneticketlink.Table:         paneticketlink.ValidColumn,
			...
			workpane.Table:               workpane.ValidColumn,
			worksurface.Table:            worksurface.ValidColumn,
