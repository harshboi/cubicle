...
func (_q *PullRequestQuery) QueryLatestEvidence() *EvidenceQuery {
...
func (_q *PullRequestQuery) WithLatestEvidence(opts ...func(*EvidenceQuery)) *PullRequestQuery {
	query := (&EvidenceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PullRequestQuery) loadLatestEvidence(ctx context.Context, query *EvidenceQuery, nodes []*PullRequest, init func(*PullRequest), assign func(*PullRequest, *Evidence)) error {
...
func (_q *PullRequestQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withLatestEvidence != nil {
			_spec.Node.AddColumnOnce(pullrequest.FieldLatestEvidenceID)
		}
	}
