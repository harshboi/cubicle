...
const (
	// Label holds the string label denoting the ticketlensresult type in the database.
	...
	// Table holds the table name of the ticketlensresult in the database.
	Table = "ticket_lens_results"
	// LensTable is the table that holds the lens relation/edge.
	LensTable = "ticket_lens_results"
	...
	LatestEvidenceTable = "ticket_lens_results"
...
func RelationKindValidator(rk RelationKind) error {
	...
	case RelationKindOwned, RelationKindReviewed, RelationKindMentionedIn:
		return nil
	default:
		return fmt.Errorf("ticketlensresult: invalid enum value for relation_kind field: %q", rk)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketlensresult: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("ticketlensresult: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketlensresult: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("ticketlensresult: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the TicketLensResult queries.
