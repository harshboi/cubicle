...
type MessageEdges struct {
	...
	// Person work panes that include this message.
...
// was not loaded in eager-loading.
func (e MessageEdges) WorkPanesOrErr() ([]*WorkPane, error) {
	if e.loadedTypes[1] {
...
// QueryWorkPanes queries the "work_panes" edge of the Message entity.
func (_m *Message) QueryWorkPanes() *WorkPaneQuery {
	return NewMessageClient(_m.config).QueryWorkPanes(_m)
}
