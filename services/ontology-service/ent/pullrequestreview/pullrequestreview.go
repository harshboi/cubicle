...
const (
	// Label holds the string label denoting the pullrequestreview type in the database.
	...
	// Table holds the table name of the pullrequestreview in the database.
	Table = "pull_request_reviews"
	// PersonTable is the table that holds the person relation/edge.
	PersonTable = "pull_request_reviews"
	...
	PullRequestTable = "pull_request_reviews"
	...
	LatestEvidenceTable = "pull_request_reviews"
...
// Columns holds all SQL columns for pullrequestreview fields.
var Columns = []string{
	FieldID,
	FieldPersonID,
	FieldPullRequestID,
...
// ReviewKind values.
const (
	ReviewKindReviewer          ReviewKind = "reviewer"
	ReviewKindApprover          ReviewKind = "approver"
	ReviewKindCommenter         ReviewKind = "commenter"
	ReviewKindRequestedReviewer ReviewKind = "requested_reviewer"
)
...
func ReviewKindValidator(rk ReviewKind) error {
	switch rk {
	case ReviewKindReviewer, ReviewKindApprover, ReviewKindCommenter, ReviewKindRequestedReviewer:
		return nil
	default:
		return fmt.Errorf("pullrequestreview: invalid enum value for review_kind field: %q", rk)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("pullrequestreview: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("pullrequestreview: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("pullrequestreview: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("pullrequestreview: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the PullRequestReview queries.
