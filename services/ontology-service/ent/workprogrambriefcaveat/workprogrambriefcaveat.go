...
const (
	// Label holds the string label denoting the workprogrambriefcaveat type in the database.
	Label = "work_program_brief_caveat"
	...
	// FieldCaveatKey holds the string denoting the caveat_key field in the database.
	FieldCaveatKey = "caveat_key"
	...
	// Table holds the table name of the workprogrambriefcaveat in the database.
	Table = "work_program_brief_caveats"
	// WorkstreamTable is the table that holds the workstream relation/edge.
	WorkstreamTable = "work_program_brief_caveats"
	...
	LatestEvidenceTable = "work_program_brief_caveats"
...
// Columns holds all SQL columns for workprogrambriefcaveat fields.
var Columns = []string{
	FieldID,
	FieldKey,
	FieldWorkstreamID,
...
var (
	...
	// CaveatKeyValidator is a validator for the "caveat_key" field. It is called by the builders before save.
	CaveatKeyValidator func(string) error
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("workprogrambriefcaveat: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("workprogrambriefcaveat: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the WorkProgramBriefCaveat queries.
...
// ByCaveatKey orders the results by the caveat_key field.
func ByCaveatKey(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCaveatKey, opts...).ToFunc()
}
