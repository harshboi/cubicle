...
type TicketEdges struct {
	...
	// Person work panes that include this ticket.
...
// was not loaded in eager-loading.
func (e TicketEdges) WorkPanesOrErr() ([]*WorkPane, error) {
	if e.loadedTypes[4] {
...
// QueryWorkPanes queries the "work_panes" edge of the Ticket entity.
func (_m *Ticket) QueryWorkPanes() *WorkPaneQuery {
	return NewTicketClient(_m.config).QueryWorkPanes(_m)
}
