...
const (
	// Label holds the string label denoting the ticketmention type in the database.
	Label = "ticket_mention"
	...
	// FieldMentionKind holds the string denoting the mention_kind field in the database.
	FieldMentionKind = "mention_kind"
	...
	// Table holds the table name of the ticketmention in the database.
	Table = "ticket_mentions"
	// PersonTable is the table that holds the person relation/edge.
	PersonTable = "ticket_mentions"
	...
	LatestEvidenceTable = "ticket_mentions"
...
// Columns holds all SQL columns for ticketmention fields.
var Columns = []string{
	FieldID,
	FieldPersonID,
	FieldTicketID,
...
// MentionKind defines the type for the "mention_kind" enum field.
type MentionKind string

// MentionKind values.
const (
	MentionKindMentioned  MentionKind = "mentioned"
	MentionKindReferenced MentionKind = "referenced"
	MentionKindRepliedTo  MentionKind = "replied_to"
)

func (mk MentionKind) String() string {
	return string(mk)
}

// MentionKindValidator is a validator for the "mention_kind" field enum values. It is called by the builders before save.
func MentionKindValidator(mk MentionKind) error {
	switch mk {
	case MentionKindMentioned, MentionKindReferenced, MentionKindRepliedTo:
		return nil
	default:
		return fmt.Errorf("ticketmention: invalid enum value for mention_kind field: %q", mk)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketmention: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("ticketmention: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketmention: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("ticketmention: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the TicketMention queries.
...
// ByMentionKind orders the results by the mention_kind field.
func ByMentionKind(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldMentionKind, opts...).ToFunc()
}
