...
const (
	...
	// FieldTicketMessageKind holds the string denoting the ticket_message_kind field in the database.
	FieldTicketMessageKind = "ticket_message_kind"
	...
	LatestEvidenceTable = "ticket_messages"
...
// TicketMessageKind defines the type for the "ticket_message_kind" enum field.
type TicketMessageKind string

// TicketMessageKind values.
const (
	TicketMessageKindDiscussedIn TicketMessageKind = "discussed_in"
)

func (tmk TicketMessageKind) String() string {
	return string(tmk)
}

// TicketMessageKindValidator is a validator for the "ticket_message_kind" field enum values. It is called by the builders before save.
func TicketMessageKindValidator(tmk TicketMessageKind) error {
	switch tmk {
	case TicketMessageKindDiscussedIn:
		return nil
	default:
		return fmt.Errorf("ticketmessage: invalid enum value for ticket_message_kind field: %q", tmk)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketmessage: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("ticketmessage: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketmessage: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("ticketmessage: invalid enum value for visibility field: %q", v)
	}
}
...
// ByTicketMessageKind orders the results by the ticket_message_kind field.
func ByTicketMessageKind(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTicketMessageKind, opts...).ToFunc()
}
