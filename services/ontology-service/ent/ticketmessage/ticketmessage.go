...
// RelationKind values.
const (
	RelationKindDiscussedIn RelationKind = "discussed_in"
)
...
func RelationKindValidator(rk RelationKind) error {
	switch rk {
	case RelationKindDiscussedIn:
		return nil
	default:
		return fmt.Errorf("ticketmessage: invalid enum value for relation_kind field: %q", rk)
	}
}
