...
const (
	// Label holds the string label denoting the pullrequestauthorship type in the database.
	Label = "pull_request_authorship"
	...
	// Table holds the table name of the pullrequestauthorship in the database.
	Table = "pull_request_authorships"
	// PersonTable is the table that holds the person relation/edge.
	PersonTable = "pull_request_authorships"
	...
	PullRequestTable = "pull_request_authorships"
	...
	LatestEvidenceTable = "pull_request_authorships"
...
// Columns holds all SQL columns for pullrequestauthorship fields.
var Columns = []string{
	FieldID,
	FieldPersonID,
	FieldPullRequestID,
...
func AuthorshipKindValidator(ak AuthorshipKind) error {
	switch ak {
	case AuthorshipKindAuthor, AuthorshipKindCreator:
		return nil
	default:
		return fmt.Errorf("pullrequestauthorship: invalid enum value for authorship_kind field: %q", ak)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("pullrequestauthorship: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("pullrequestauthorship: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("pullrequestauthorship: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("pullrequestauthorship: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the PullRequestAuthorship queries.
