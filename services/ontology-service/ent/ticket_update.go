...
func (_u *TicketUpdate) AddWorkPaneIDs(ids ...int) *TicketUpdate {
	_u.mutation.AddWorkPaneIDs(ids...)
	return _u
}

// AddWorkPanes adds the "work_panes" edges to the WorkPane entity.
func (_u *TicketUpdate) AddWorkPanes(v ...*WorkPane) *TicketUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddWorkPaneIDs adds the "work_panes" edge to the WorkPane entity by IDs.
func (_u *TicketUpdateOne) AddWorkPaneIDs(ids ...int) *TicketUpdateOne {
	_u.mutation.AddWorkPaneIDs(ids...)
	return _u
}

// AddWorkPanes adds the "work_panes" edges to the WorkPane entity.
func (_u *TicketUpdateOne) AddWorkPanes(v ...*WorkPane) *TicketUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearWorkPanes clears all "work_panes" edges to the WorkPane entity.
func (_u *TicketUpdateOne) ClearWorkPanes() *TicketUpdateOne {
	_u.mutation.ClearWorkPanes()
	return _u
}

// RemoveWorkPaneIDs removes the "work_panes" edge to WorkPane entities by IDs.
func (_u *TicketUpdateOne) RemoveWorkPaneIDs(ids ...int) *TicketUpdateOne {
	_u.mutation.RemoveWorkPaneIDs(ids...)
	return _u
}

// RemoveWorkPanes removes "work_panes" edges to WorkPane entities.
func (_u *TicketUpdateOne) RemoveWorkPanes(v ...*WorkPane) *TicketUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
