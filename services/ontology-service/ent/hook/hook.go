...
// The AssociationFunc type is an adapter to allow the use of ordinary
// function as Association mutator.
type AssociationFunc func(context.Context, *ent.AssociationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AssociationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AssociationMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AssociationMutation", m)
}
