...
// The PaneDocumentLinkFunc type is an adapter to allow the use of ordinary
// function as PaneDocumentLink mutator.
type PaneDocumentLinkFunc func(context.Context, *ent.PaneDocumentLinkMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PaneDocumentLinkFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PaneDocumentLinkMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PaneDocumentLinkMutation", m)
}

// The PaneMessageLinkFunc type is an adapter to allow the use of ordinary
// function as PaneMessageLink mutator.
type PaneMessageLinkFunc func(context.Context, *ent.PaneMessageLinkMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PaneMessageLinkFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PaneMessageLinkMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PaneMessageLinkMutation", m)
}

// The PanePullRequestLinkFunc type is an adapter to allow the use of ordinary
// function as PanePullRequestLink mutator.
type PanePullRequestLinkFunc func(context.Context, *ent.PanePullRequestLinkMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PanePullRequestLinkFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PanePullRequestLinkMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PanePullRequestLinkMutation", m)
}

// The PaneTicketLinkFunc type is an adapter to allow the use of ordinary
// function as PaneTicketLink mutator.
type PaneTicketLinkFunc func(context.Context, *ent.PaneTicketLinkMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PaneTicketLinkFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PaneTicketLinkMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PaneTicketLinkMutation", m)
}
...
// The WorkPaneFunc type is an adapter to allow the use of ordinary
// function as WorkPane mutator.
type WorkPaneFunc func(context.Context, *ent.WorkPaneMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WorkPaneFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WorkPaneMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WorkPaneMutation", m)
}

// The WorkSurfaceFunc type is an adapter to allow the use of ordinary
// function as WorkSurface mutator.
type WorkSurfaceFunc func(context.Context, *ent.WorkSurfaceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WorkSurfaceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WorkSurfaceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WorkSurfaceMutation", m)
}
