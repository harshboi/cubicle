...
func (_q *MessageQuery) QueryLatestEvidence() *EvidenceQuery {
...
func (_q *MessageQuery) WithLatestEvidence(opts ...func(*EvidenceQuery)) *MessageQuery {
	query := (&EvidenceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MessageQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Message, error) {
	...
	if query := _q.withLatestEvidence; query != nil {
		if err := _q.loadLatestEvidence(ctx, query, nodes, nil,
			func(n *Message, e *Evidence) { n.Edges.LatestEvidence = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MessageQuery) loadLatestEvidence(ctx context.Context, query *EvidenceQuery, nodes []*Message, init func(*Message), assign func(*Message, *Evidence)) error {
...
func (_q *MessageQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withLatestEvidence != nil {
			_spec.Node.AddColumnOnce(message.FieldLatestEvidenceID)
		}
	}
