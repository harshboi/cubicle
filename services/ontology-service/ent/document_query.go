...
type DocumentQuery struct {
	...
	withOutgoingDocumentLinks *DocumentLinkQuery
	withIncomingDocumentLinks *DocumentLinkQuery
...
func (_q *DocumentQuery) QueryTickets() *TicketQuery {
...
// QueryOutgoingDocumentLinks chains the current query on the "outgoing_document_links" edge.
func (_q *DocumentQuery) QueryOutgoingDocumentLinks() *DocumentLinkQuery {
	query := (&DocumentLinkClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryIncomingDocumentLinks chains the current query on the "incoming_document_links" edge.
func (_q *DocumentQuery) QueryIncomingDocumentLinks() *DocumentLinkQuery {
	query := (&DocumentLinkClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *DocumentQuery) QueryLatestEvidence() *EvidenceQuery {
...
func (_q *DocumentQuery) Clone() *DocumentQuery {
	...
	return &DocumentQuery{
		...
		withOutgoingDocumentLinks: _q.withOutgoingDocumentLinks.Clone(),
		withIncomingDocumentLinks: _q.withIncomingDocumentLinks.Clone(),
...
func (_q *DocumentQuery) WithTickets(opts ...func(*TicketQuery)) *DocumentQuery {
	query := (&TicketClient{config: _q.config}).Query()
...
// WithOutgoingDocumentLinks tells the query-builder to eager-load the nodes that are connected to
// the "outgoing_document_links" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *DocumentQuery) WithOutgoingDocumentLinks(opts ...func(*DocumentLinkQuery)) *DocumentQuery {
	query := (&DocumentLinkClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withOutgoingDocumentLinks = query
	return _q
}

// WithIncomingDocumentLinks tells the query-builder to eager-load the nodes that are connected to
// the "incoming_document_links" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *DocumentQuery) WithIncomingDocumentLinks(opts ...func(*DocumentLinkQuery)) *DocumentQuery {
	query := (&DocumentLinkClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withIncomingDocumentLinks = query
	return _q
}
...
func (_q *DocumentQuery) WithLatestEvidence(opts ...func(*EvidenceQuery)) *DocumentQuery {
	query := (&EvidenceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DocumentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Document, error) {
	var (
		...
		loadedTypes = [4]bool{
			_q.withTickets != nil,
			_q.withOutgoingDocumentLinks != nil,
			_q.withIncomingDocumentLinks != nil,
	...
	if query := _q.withTickets; query != nil {
		if err := _q.loadTickets(ctx, query, nodes,
			func(n *Document) { n.Edges.Tickets = []*Ticket{} },
			func(n *Document, e *Ticket) { n.Edges.Tickets = append(n.Edges.Tickets, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOutgoingDocumentLinks; query != nil {
		if err := _q.loadOutgoingDocumentLinks(ctx, query, nodes,
			func(n *Document) { n.Edges.OutgoingDocumentLinks = []*DocumentLink{} },
			func(n *Document, e *DocumentLink) {
				n.Edges.OutgoingDocumentLinks = append(n.Edges.OutgoingDocumentLinks, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withIncomingDocumentLinks; query != nil {
		if err := _q.loadIncomingDocumentLinks(ctx, query, nodes,
			func(n *Document) { n.Edges.IncomingDocumentLinks = []*DocumentLink{} },
			func(n *Document, e *DocumentLink) {
				n.Edges.IncomingDocumentLinks = append(n.Edges.IncomingDocumentLinks, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := _q.withLatestEvidence; query != nil {
		if err := _q.loadLatestEvidence(ctx, query, nodes, nil,
			func(n *Document, e *Evidence) { n.Edges.LatestEvidence = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DocumentQuery) loadTickets(ctx context.Context, query *TicketQuery, nodes []*Document, init func(*Document), assign func(*Document, *Ticket)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(document.TicketsTable)
		s.Join(joinT).On(s.C(ticket.FieldID), joinT.C(document.TicketsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(document.TicketsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(document.TicketsPrimaryKey[1]))
...
func (_q *DocumentQuery) loadOutgoingDocumentLinks(ctx context.Context, query *DocumentLinkQuery, nodes []*Document, init func(*Document), assign func(*Document, *DocumentLink)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(documentlink.FieldFromDocumentID)
	}
	query.Where(predicate.DocumentLink(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(document.OutgoingDocumentLinksColumn), fks...))
	}))
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "from_document_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *DocumentQuery) loadIncomingDocumentLinks(ctx context.Context, query *DocumentLinkQuery, nodes []*Document, init func(*Document), assign func(*Document, *DocumentLink)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Document)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(documentlink.FieldToDocumentID)
	}
	query.Where(predicate.DocumentLink(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(document.IncomingDocumentLinksColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "to_document_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *DocumentQuery) loadLatestEvidence(ctx context.Context, query *EvidenceQuery, nodes []*Document, init func(*Document), assign func(*Document, *Evidence)) error {
...
func (_q *DocumentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withLatestEvidence != nil {
			_spec.Node.AddColumnOnce(document.FieldLatestEvidenceID)
		}
	}
