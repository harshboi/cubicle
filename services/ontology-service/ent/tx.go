...
func (tx *Tx) init() {
	...
	tx.PaneDocumentLink = NewPaneDocumentLinkClient(tx.config)
	tx.PaneMessageLink = NewPaneMessageLinkClient(tx.config)
	tx.PanePullRequestLink = NewPanePullRequestLinkClient(tx.config)
	tx.PaneTicketLink = NewPaneTicketLinkClient(tx.config)
	...
	tx.WorkPane = NewWorkPaneClient(tx.config)
	tx.WorkSurface = NewWorkSurfaceClient(tx.config)
