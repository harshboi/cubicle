...
const (
	// Label holds the string label denoting the ticketdocument type in the database.
	Label = "ticket_document"
	...
	// FieldTicketDocumentKind holds the string denoting the ticket_document_kind field in the database.
	FieldTicketDocumentKind = "ticket_document_kind"
	...
	// Table holds the table name of the ticketdocument in the database.
	Table = "ticket_documents"
	// TicketTable is the table that holds the ticket relation/edge.
	TicketTable = "ticket_documents"
	...
	DocumentTable = "ticket_documents"
	...
	LatestEvidenceTable = "ticket_documents"
...
// Columns holds all SQL columns for ticketdocument fields.
var Columns = []string{
	FieldID,
	FieldTicketID,
	FieldDocumentID,
...
// TicketDocumentKind defines the type for the "ticket_document_kind" enum field.
type TicketDocumentKind string

// TicketDocumentKind values.
const (
	TicketDocumentKindDocumentedBy TicketDocumentKind = "documented_by"
)

func (tdk TicketDocumentKind) String() string {
	return string(tdk)
}

// TicketDocumentKindValidator is a validator for the "ticket_document_kind" field enum values. It is called by the builders before save.
func TicketDocumentKindValidator(tdk TicketDocumentKind) error {
	switch tdk {
	case TicketDocumentKindDocumentedBy:
		return nil
	default:
		return fmt.Errorf("ticketdocument: invalid enum value for ticket_document_kind field: %q", tdk)
	}
}
...
func DeletionStateValidator(ds DeletionState) error {
	...
	case DeletionStatePresent, DeletionStateDeleted, DeletionStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketdocument: invalid enum value for deletion_state field: %q", ds)
	}
}
...
func ACLStateValidator(as ACLState) error {
	...
	case ACLStateUnknown, ACLStateCurrent, ACLStateStale, ACLStateBlocked, ACLStateUnavailable:
		return nil
	default:
		return fmt.Errorf("ticketdocument: invalid enum value for acl_state field: %q", as)
	}
}
...
func FreshnessStateValidator(fs FreshnessState) error {
	...
	case FreshnessStateFresh, FreshnessStatePartial, FreshnessStateStale, FreshnessStateUnknown:
		return nil
	default:
		return fmt.Errorf("ticketdocument: invalid enum value for freshness_state field: %q", fs)
	}
}
...
func VisibilityValidator(v Visibility) error {
	...
	case VisibilityUnknown, VisibilityPublic, VisibilityPrivate, VisibilityTeam, VisibilityRestricted:
		return nil
	default:
		return fmt.Errorf("ticketdocument: invalid enum value for visibility field: %q", v)
	}
}

// OrderOption defines the ordering options for the TicketDocument queries.
...
// ByTicketDocumentKind orders the results by the ticket_document_kind field.
func ByTicketDocumentKind(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTicketDocumentKind, opts...).ToFunc()
}
